...
urlpatterns = [
    ...
    path("add-airplane-like/<int:id>/<str:redirect_address>/<int:chousen_id>/",
         views.AddAirplaneLike.as_view(), name='add-airplane-like'),
    path("tag-plane/<int:id>/<str:redirect_address>/<int:chousen_id>/", views.TagPlane.as_view(), name='tag-plane'),
    path("order-by-nation/<int:id>/", views.OrderByNation.as_view(), name='order_by_nation'),
    path("order-by-category/<int:id>/", views.OrderByCategory.as_view(), name='order_by_category'),
